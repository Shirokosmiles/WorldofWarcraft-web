...
class Activity extends Component
{
    ...
    public function getSessionsProperty()
    {
        ...
        return collect(
            ...
            return (object) [
                ...
                'region_name' => $this->getIpInfo($session->ip_address)['country_name'],
                'city' => $this->getIpInfo($session->ip_address)['city'],
    ...
    public function getIpInfo($ips) {
        $ip = '84.53.238.178';
        $access_key = 'bc10eeec1de446db62f36389ec0fc173';
        $ch = curl_init('http://api.ipstack.com/' .$ips.'?access_key='.$access_key.'');
    ...
    {
        return view('livewire.profile.security.activity');
    }
}
