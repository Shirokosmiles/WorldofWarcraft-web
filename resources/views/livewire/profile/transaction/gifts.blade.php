        ...
        <div data-v-547979d4="">
            <div data-v-70ad3292="" class="account-table-container">
                <table data-v-483e03c5="" data-v-70ad3292="" class="table b-table table-dark gift-claims-table thead-no-border thead-text-normal card-background-color mt-md-5">
                    ...
                    <tr>
                        <th tabindex="0" aria-colindex="1" aria-label="Click to sort Ascending" aria-sort="descending" class="sorting sorting_desc d-none d-md-table-cell blz-md-15 text-nowrap">Дата</th><th aria-colindex="2" class="w-100 pl-sm-3 pr-sm-1 text-nowrap">Продукт/услуга</th><th aria-colindex="3" class="blz-xs-35 blz-md-15 pl-1 pl-md-4 text-nowrap">Статус</th></tr></thead>
                    <tbody class="">
                        ...
                        <tr aria-rowindex="{{ $loop->index }}" class="">
                            ...
                            <td aria-colindex="3" class="blz-xs-35 blz-md-15 pl-1 pl-md-4 pr-3 pr-md-5 align-left align-middle text-white blz-text-md-white-70">
                                <div data-v-70ad3292="" class="text-nowrap d-flex align-items-center justify-content-end justify-content-md-start">
                                    ...
                                    @else
                                        @if(auth()->user()->activeCharacters)
                                            <livewire:profile.transaction.send-gifts :item="$item" />
                                        @elseif($item->type == "vote")
                                            <livewire:profile.transaction.send-vote-gifts :item="$item" />
                                        @else
