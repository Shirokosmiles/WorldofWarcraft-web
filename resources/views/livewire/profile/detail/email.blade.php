    ...
    <div data-v-15d61d2e="" class="card-title">
        <div data-v-f521b32c="" data-v-15d61d2e="" class="row">
            <div data-v-f521b32c="" data-v-15d61d2e="" class="col-12 col-md-6">
                <h3 data-v-f521b32c="" data-v-15d61d2e="">@lang('detail.detail_9')</h3>
            </div>
            <div data-v-f521b32c="" data-v-15d61d2e="" class="col-12 col-md-6">
    ...
    <div data-v-15d61d2e="" class="card-subtitle">
        <div data-v-f521b32c="" data-v-15d61d2e="">
            @if(!auth()->user()->email_verified_at)
                <div data-v-cc173d72="" data-v-f521b32c="" class="alert-message info" data-v-15d61d2e="">
                    ...
                    <div data-v-cc173d72="" class="">
                        ...
                        <ul data-v-f521b32c="">
                            <li data-v-f521b32c="">
                                <span data-v-f521b32c="">
                                @lang('detail.detail_10') {{ auth()->user()->email_hidden }}.
                                @if(session('message'))
                                        <span data-v-f521b32c="">
                                        @lang('detail.detail_11')
                                        </span>
                                    @else
                                        <span data-v-f521b32c="">
                                            <form method="POST" action="{{ route('verification.send') }}">
                                                @csrf
                                                <div>
                                                    <button type="submit" data-v-312dd04b="" data-v-112a4620="" data-v-15d61d2e="" class="btn-primary btn">
                                                        @lang('detail.resend')
                                                    </button>
                                                </div>
                                            </form>
        ...
        <div data-v-f521b32c="" data-v-15d61d2e="">
            ...
            <div data-v-f521b32c="" data-v-15d61d2e="" class="">
                <div x-show=!updateEmail data-v-f521b32c="" data-v-15d61d2e="">
                    <div data-v-f521b32c="" data-v-15d61d2e="" class="row mt-3 mt-sm-0">
                        <div data-v-f521b32c="" data-v-15d61d2e="" class="col-sm-12 col-sm-3 col-md-3 col-xl-2 label">@lang('detail.detail_12')</div>
                        ...
                        <div data-v-f521b32c="" data-v-15d61d2e="" class="row">
                            ...
                            <div data-v-f521b32c="" data-v-15d61d2e="" class="col-sm-12 col-md-6 col-xl-5 col-lg-7">
                                <input data-v-f521b32c="" data-v-15d61d2e="" type="text" id="email" wire:model.defer="state.email" name="email"
                                       placeholder="@lang('detail.detail_12')" data-vv-validate-on="blur" data-vv-as="@lang('detail.detail_12')" class="input-block" aria-required="true" aria-invalid="false">
