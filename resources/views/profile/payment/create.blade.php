    ...
    <section class="main-content-section">
        <div data-v-a1d75ea0="" class="payment-overview">
            <div data-v-ba34107c="" data-v-a1d75ea0="" class="title-bar text-center text-lg-left position-relative">
                <h1 data-v-ba34107c="">@lang('payment.payment_1')</h1>
            ...
            <div data-v-2d0dc31c="">
                <div data-v-15d61d2e="" data-v-2d0dc31c="" class="card">
                    <div data-v-15d61d2e="" class="card-title">
                        <div data-v-2d0dc31c="" data-v-15d61d2e="">
                            <h3 data-v-2d0dc31c="" data-v-15d61d2e="">@lang('payment.payment_2')</h3>
                        </div>
                    </div>
                    <div data-v-15d61d2e="" class="card-body">
                        <livewire:profile.payment.create />
                    </div>
                </div>
            </div>
        </div>
