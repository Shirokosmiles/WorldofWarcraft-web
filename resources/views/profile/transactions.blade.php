<x-app-layout>
    <section class="main-content-section">
        <div data-v-547979d4="" class="transactions-overview">
            <div data-v-ba34107c="" data-v-547979d4="" class="title-bar text-center text-lg-left position-relative mb-md-0 pb-md-0">
            ...
            <div data-v-547979d4="" class="mt-sm-0 mt-md-4 pt-md-1 tabs">
                <livewire:profile.transaction.show :user="auth()->user()" />
            </div>
        </div>
    </section>
</x-app-layout>
