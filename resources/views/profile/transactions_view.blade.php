    ...
    <section class="main-content-section">
        ...
        <div data-v-ba34107c="" data-v-6d23d421="" class="title-bar text-center text-lg-left position-relative pb-md-0">
            ...
            <div data-v-ba34107c="" class="back d-lg-none position-absolute">
                <a data-v-ba34107c="" href="{{ route('transactions') }}" class="router-link-active">
        ...
        <div data-v-6d23d421="">
            <a href="{{ route('transactions') }}" class="d-none d-md-block router-link-active mt-0 mb-3">
                &lt; К истории операций
            </a>
        </div>
        <div data-v-15d61d2e="" data-v-6d23d421=""  class="card mt-4 mt-m-2">
            <livewire:profile.transaction.view :order="$order_id" />
        </div>
    </div>
    </section>
</x-app-layout>
