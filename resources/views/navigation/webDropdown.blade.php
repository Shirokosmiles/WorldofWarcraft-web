                        ...
                        <div class="Grid-1of5">
                            <div class="List List--full List--vertical List--separator List--separatorBrownMedium">
                                <div class="List-item gutter-tiny gutter-vertical">
                                    <div class="SiteNav-sectionTitle font-title-tiny-onDark">
                                    ...
                                    @if(!$menu->children->isEmpty())
                                        @foreach($menu->children as $item)
                                            <div class="gutter-vertical gutter-tiny">
                                                <a class="Link Link--block SiteNav-pageLink" href="{{ $item->link()
                                                   ...
                                                   data-analytics-placement="Game - Gameplay - Races">
                                                    ...
                                                    @if($item->new_menu)<sup class="font-sup color-gold-medium">Новый</sup>@endif
                                                </a>
                                            </div>
                                        @endforeach
                                    @endif
